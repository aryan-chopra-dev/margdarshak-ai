...
export const knowledgeBase: KnowledgeChunk[] = [
  // ---- VISA INFORMATION ----
  {
    ...
    content: `To apply for a US F-1 student visa, you need: (1) Form I-20 from your US university, (2) DS-160 online application, (3) SEVIS fee payment receipt (I-901, currently $350), (4) Valid passport with at least 6 months validity, (5) Passport-size photograph per US visa photo requirements, (6) Proof of financial support showing you can cover tuition + living costs for at least the first year, (7) Academic transcripts and test scores, (8) Visa interview at the US Embassy/Consulate. The visa fee is $185 (MRV fee). Current wait times for visa interviews in India vary by city: Delhi (20-40 days), Mumbai (30-50 days), Chennai (15-30 days), Hyderabad (20-35 days), Kolkata (10-20 days). OPT (Optional Practical Training) allows 12 months of post-graduation work, extended to 36 months total for STEM degrees.`,
  ...
  },
  {
    ...
    content: `Australia Student Visa requirements: (1) CoE (Confirmation of Enrolment), (2) Genuine Temporary Entrant (GTE) statement, (3) English proficiency (IELTS Academic 5.5-6.5), (4) Financial capacity — AUD$24,505/year living costs + tuition, (5) OSHC (Overseas Student Health Cover), (6) Visa fee: AUD$710. Post-Study Work visa (Subclass 485): 2 years for bachelor's, 3 years for master's, 4 years for PhD. You can work 48 hours per fortnight during study.`,
  ...
  },
  {
    ...
    content: `Germany Student Visa requirements: (1) Admission letter from a German university, (2) Blocked account (Sperrkonto) with €11,208/year (~€934/month), (3) Health insurance, (4) Academic qualifications (verified by uni-assist), (5) Visa fee: €75. Most public universities in Germany charge NO TUITION — only a semester contribution of €150-350. Baden-Württemberg charges €1,500/semester for non-EU students. Post-study: 18-month job-seeking visa after graduation. Part-time work: 120 full days or 240 half days per year during studies.`,
  ...
  // ---- SCHOLARSHIPS ----
  {
    ...
    content: `Fulbright-Nehru Master's Fellowships are for Indian students pursuing a master's degree at select US institutions. Covers: tuition, living stipend ($2,000-2,600/month), airfare, health insurance, book allowance. Duration: up to 2 years. Application opens: February, deadline: May each year. Eligibility: Indian citizen, bachelor's degree with 55%+, at least 3 years work experience (for some categories). Highly competitive — approximately 100 fellowships awarded annually. Fields: all except medicine and law.`,
